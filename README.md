# 💸 Luna's Economy Plugin [![](https://github.com/lunaplugins/economy/actions/workflows/build.yml/badge.svg)](https://github.com/lunaplugins/economy/actions/workflows/build.yml)
...
A modern and performant economy plugin!

> [!CAUTION]
> This plugin is still work-in-progress and cannot be used.
> Please come back later. Once it is ready, a release will be published!

## 🔨 Building this plugin

1. Clone the repository
   ```bash
   git clone https://github.com/lunaplugins/economy.git LunaEconomy
   cd LunaEconomy
   ```
